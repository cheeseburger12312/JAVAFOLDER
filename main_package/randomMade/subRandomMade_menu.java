package main_package.randomMade;
import java.util.Scanner;

import main_package.Main;
import main_package.randomMade.subRandomMade.BMI;

public class subRandomMade_menu {
    public static void subandomDestination() {
        while (true) {
            String input;
            int userChoice = 0; 
            ...
            switch (userChoice) {
                case 1:
                    System.out.println("User choosed [1].BMI");
                    BMI.BMImain();
                    break;
                case 2:
